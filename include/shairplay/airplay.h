...
struct airplay_callbacks_s {
	...
	void (*photo_cb)(void *cls, void *session, char *data, int datalen);
	void (*play_cb)(void *cls, void *session, char *data, int datalen);
	void (*stop_cb)(void *cls, void *session, char *data, int datalen);
	void (*rate_set_cb)(void *cls, void *session, char *data, int datalen);
	void (*scrub_get_cb)(void *cls, void *session, char *data, int datalen);
	void (*scrub_set_cb)(void *cls, void *session, char *data, int datalen);
	void (*playback_info_cb)(void *cls, void *session, char *data, int datalen);
};
